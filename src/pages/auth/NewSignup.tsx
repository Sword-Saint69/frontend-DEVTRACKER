  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="absolute top-4 right-4 z-10">
        <AnimatedThemeToggler className="w-6 h-6 p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" />
      </div>
      ...
      <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
        ...
        <form className="my-8" onSubmit={handleSubmit}>
          ...
          <LabelInputContainer className="mb-4">
            ...
            <Input id="email" placeholder="projectdev@example.com" type="email" />
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
